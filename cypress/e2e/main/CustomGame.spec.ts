describe('Custom game', () => {
  ...
  context('Add custom game', () => {
    ...
    it('Add game', () => {
      ...
      cy.get('[data-testid="add-game-input"] > input').should('have.value', 'Emerald Kaizo');
      cy.contains('Save').click();
      ...
      cy.get('[data-testid="add-cap"]').click();
      cy.get('[data-testid="custom-badge-input-0"] > input').type('10');
      cy.get('[data-testid="custom-badge-input-0"] > input').should('have.value', '010');
      cy.contains('Cancel').click();
