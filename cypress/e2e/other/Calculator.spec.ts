...
describe('Calculator', () => {
  ...
  it('Base Calculations', { scrollBehavior: 'center' }, () => {
    ...
    cy.get('[data-testid="level-input1"]').clear();
    cy.get('[data-testid="level-input1"]').type('10');
    cy.get('[data-testid="level-input1"]').should('have.value', '10');
    ...
    cy.get('[data-testid="ability1"] > .search').click();
    cy.get('[data-testid="ability1"] > .search').type('Overgrow');
    ...
    cy.get('[data-testid="evhp1"]')
      .then(($el) => stepTo($el, 0))
      .trigger('change');
    cy.get('[data-testid="currenthp1"]').clear();
    cy.get('[data-testid="currenthp1"]').type('50');
